  ...
  <div class="template-options">
    ...
    <div class="custom-scroll custom-scroll-dark">
      <ul class="nav nav-tabs nav-tabs-2 m-b-0-5" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#layout" role="tab"
            aria-expanded="true"><?php echo $this->lang->line('xin_layout_settings'); ?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab_setting" role="tab"
            aria-expanded="false"><?php echo $this->lang->line('xin_other_settings'); ?></a>
        </li>
      </ul>
      <div class="tab-content">
          ...
          <form id="layout_skin_info" action="<?php echo site_url("settings/layout_skin_info"); ?>"
            ...
            <div class="to-content">
              <?php if ($system[0]->enable_layout == 'yes'): ?>
                ...
                <div class="row text-xs-center">
                  ...
                  <div class="col-xs-6 mb-2">
                    <div class="to-item">
                      <label>
                        <input name="static" type="checkbox" value="static" <?php if ($system[0]->layout_static != '') { ?>
                            checked="checked" <?php } ?>>
                        <div class="to-icon"><i class="ti-check"></i></div>
              ...
              <div class="row">
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    ...
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="skin-dark-blue"></span> <span class="skin-white"></span> <span
                        class="skin-dark-blue"></span> </div>
                  </label>
                </div>
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-1" type="radio" <?php if ($system[0]->system_skin == 'skin-1') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                ...
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-2" type="radio" <?php if ($system[0]->system_skin == 'skin-2') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="bg-danger"></span> <span class="bg-white"></span> <span
                        class="bg-black"></span> </div>
                  </label>
                </div>
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-3" type="radio" <?php if ($system[0]->system_skin == 'skin-3') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="bg-white"></span> <span class="bg-white"></span> <span
                        class="bg-white"></span> </div>
                  </label>
                </div>
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-4" type="radio" <?php if ($system[0]->system_skin == 'skin-4') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="bg-white"></span> <span class="skin-dark-blue-2"></span> <span
                        class="bg-white"></span> </div>
                  </label>
                </div>
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-5" type="radio" <?php if ($system[0]->system_skin == 'skin-5') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="bg-primary-light"></span> <span class="bg-primary"></span> <span
                        class="bg-white"></span> </div>
                  </label>
                </div>
                <div class="col-xs-3 mb-2">
                  <label class="skin-label">
                    <input name="skin" value="skin-6" type="radio" <?php if ($system[0]->system_skin == 'skin-6') { ?>
                        checked="checked" <?php } ?>>
                    <div class="to-icon"><i class="ti-check"></i></div>
                    <div class="to-skin"> <span class="bg-black"></span> <span class="bg-info"></span> <span
                        class="bg-black"></span> </div>
                  </label>
                </div>
              </div>
              <div class="to-material">
                <button type="submit"
                  class="btn-block waves-effect waves-light mb-2 btn btn-primary save"><?php echo $this->lang->line('xin_update'); ?></button>
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="tab-pane" id="tab_setting" role="tabpanel">
          <form id="sidebar_setting_info" action="<?php echo site_url("settings/sidebar_setting_info"); ?>"
            name="sidebar_setting_info" method="post">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
              value="<?php echo $this->security->get_csrf_hash(); ?>">
            <input type="hidden" name="token" value="1DR59ik46kLKR4E" />
            <div class="sidebar-settings animated fadeIn">
              <div class="sidebar-group">
                ...
                <div class="ss-item">
                  ...
                  <div class="ss-checkbox"><input type="checkbox" id="enable_attendance" class="js-switch"
                      data-size="small" data-color="#3e70c9" <?php if ($system[0]->enable_attendance == 'yes'): ?>
                        checked="checked" <?php endif; ?> value="yes"></div>
                </div>
                <div class="ss-item">
                  <div class="text-truncate"><?php echo $this->lang->line('xin_enable_jobs_for_employees'); ?></div>
                  <div class="ss-checkbox"><input type="checkbox" id="enable_job" class="js-switch" data-size="small"
                      data-color="#3e70c9" <?php if ($system[0]->enable_job_application_candidates == 'yes'): ?>
                        checked="checked" <?php endif; ?> value="yes"></div>
                </div>
                <div class="ss-item">
                  <div class="text-truncate"><?php echo $this->lang->line('xin_employee_can_change_profile_cover'); ?>
                  </div>
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->enable_profile_background == 'yes'): ?> checked="checked" <?php endif; ?>
                      value="yes" id="enable_profile_background"></div>
                </div>
              </div>
              <div class="sidebar-group">
                ...
                <div class="ss-item">
                  ...
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->enable_email_notification == 'yes'): ?> checked="checked" <?php endif; ?>
                      value="yes" id="role_email_notification"></div>
                </div>
                <div class="ss-item">
                  <div class="text-truncate"><?php echo $this->lang->line('xin_enable_notification_close_btn'); ?></div>
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->notification_close_btn == 'true'): ?> checked="checked" <?php endif; ?>
                      value="true" id="close_btn"></div>
                </div>
                <div class="ss-item">
                  <div class="text-truncate"><?php echo $this->lang->line('xin_notification_progress_bar'); ?></div>
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->notification_bar == 'true'): ?> checked="checked" <?php endif; ?> value="true"
                      id="notification_bar"></div>
                </div>
              </div>
              <div class="sidebar-group">
                ...
                <div class="ss-item">
                  ...
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->enable_policy_link == 'yes'): ?> checked="checked" <?php endif; ?> value="yes"
                      id="role_policy_link"></div>
                </div>
                <div class="ss-item">
                  <div class="text-truncate"><?php echo $this->lang->line('xin_enable_layout_setting'); ?></div>
                  <div class="ss-checkbox"><input type="checkbox" class="js-switch" data-size="small" data-color="#3e70c9"
                      <?php if ($system[0]->enable_layout == 'yes'): ?> checked="checked" <?php endif; ?> value="yes"
                      id="enable_layout"></div>
                </div>
              </div>
            </div>
            <div class="to-material">
      ...
      <ul class="nav navbar-nav float-md-right">
        <li class="nav-item dropdown">
          <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false"> <img
              src="<?php echo base_url() ?>skin/img/flags/<?php echo $this->Xin_model->get_selected_language_flag($wz_lang); ?>"
              alt="<?php echo $this->Xin_model->get_selected_language_name($wz_lang); ?>">
            <?php echo $this->Xin_model->get_selected_language_name($wz_lang); ?></a>
        ...
        <?php if ($system[0]->enable_policy_link == 'yes'): ?>
          <li class="nav-item"> <a class="nav-link" href="#" data-toggle="modal" data-target=".policy"> <i
        ...
        <?php if ($user_info[0]->user_role_id == 1) { ?>
          <li class="nav-item dropdown"> <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false"
            ...
            <div
              ...
              <?php } ?>
              <a class="dropdown-more" href="<?php echo site_url() ?>timesheet/leave/">
                <strong><?php echo $this->lang->line('header_view_all_leave'); ?></strong> </a>
            </div>
          </li>
        <?php } ?>
        <?php if (in_array('53', $role_resources_ids) || in_array('54', $role_resources_ids) || in_array('55', $role_resources_ids) || in_array('56', $role_resources_ids)) { ?>
          <li class="nav-item dropdown"> <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false"
              data-placement="bottom"> <i class="ti-settings"></i> <span
                class="hidden-md-up ml-1"><?php echo $this->lang->line('left_settings'); ?></span> </a>
            <div class="dropdown-menu dropdown-menu-right animated <?php echo $system[0]->animation_effect_topmenu; ?>">
              <?php if (in_array('53', $role_resources_ids)) { ?>
                <a class="dropdown-item" href="<?php echo site_url() ?>settings/">
                  <?php echo $this->lang->line('header_configuration'); ?> </a>
              <?php } ?>
              <?php if (in_array('54', $role_resources_ids)) { ?>
                <a class="dropdown-item" href="<?php echo site_url() ?>settings/constants/">
                  <?php echo $this->lang->line('left_constants'); ?> </a>
              <?php } ?>
              <?php if (in_array('55', $role_resources_ids)) { ?>
                <a class="dropdown-item" href="<?php echo site_url() ?>settings/email_template/">
                  <?php echo $this->lang->line('left_email_templates'); ?> </a>
              <?php } ?>
              <?php if (in_array('56', $role_resources_ids)) { ?>
                <a class="dropdown-item" href="<?php echo site_url() ?>settings/database_backup/">
                  <?php echo $this->lang->line('header_db_log'); ?> </a>
              <?php } ?>
            </div>
          </li>
        <?php } ?>
        ...
        <li class="nav-item dropdown hidden-sm-down">
            ...
            <span class="avatar box-32">
              <?php if ($user_info[0]->profile_picture != '' && $user_info[0]->profile_picture != 'no file') { ?>
                <img src="<?php echo base_url() . 'uploads/profile/' . $user_info[0]->profile_picture; ?>" alt=""
                  id="user_avatar" class="b-a-radius-circle user_profile_avatar">
              <?php } else { ?>
          ...
          <div class="dropdown-menu dropdown-menu-right animated <?php echo $system[0]->animation_effect_topmenu; ?>">
            ...
            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target=".pro_change_password"
              data-profile_id="<?php echo $session['user_id']; ?>"><i class="fa fa-key mr-0-5"></i>
              <?php echo $this->lang->line('header_change_password'); ?></a>
            <a class="dropdown-item" href="<?php echo site_url() ?>logout/"><i class="ti-power-off mr-0-5"></i>
              <?php echo $this->lang->line('header_sign_out'); ?></a>
          </div>
        </li>
      </ul>
      <ul class="nav navbar-nav">
        <li class="nav-item hidden-sm-down"> <a class="nav-link toggle-fullscreen" href="#"> <i
          ...
          <?php if ($system[0]->enable_attendance == 'yes' && $system[0]->enable_clock_in_btn == 'yes') { ?>
            <li class="nav-item hidden-sm-down clock-in-btn">
              <form name="set_clocking" id="set_clocking_hd" method="post">
                ...
                <?php $attendances = $this->Xin_model->attendance_time_checks($session['user_id']);
                ...
                <?php if ($attendances->num_rows() < 1) { ?>
                  ...
                  <button class="btn btn-success text-uppercase w-min-sm mb-0-25 waves-effect waves-light" type="submit"><i
                ...
                <?php } else { ?>
                  ...
                  <button class="btn btn-warning text-uppercase w-min-sm mb-0-25 waves-effect waves-light" type="submit"><i
...
<div class="modal fade pro_change_password animated <?php echo $system[0]->animation_effect_modal; ?>"
  id="pro_change_password" tabindex="-1" role="dialog" aria-labelledby="pro_change_password" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="change_password_modal"></div>
  </div>
</div>
<div class="modal fade policy animated <?php echo $system[0]->animation_effect_modal; ?>" id="policy" tabindex="-1"
  role="dialog" aria-labelledby="policy" aria-hidden="true">

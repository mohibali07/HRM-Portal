...
class Timesheet extends MY_Controller
{
	...
	public function attendance_list()
	{
		...
		foreach ($employee->result() as $r) {
			...
			if ($day == 'Monday') {
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->monday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->tuesday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->wednesday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->thursday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->friday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->saturday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {
				...
				if (is_null($office_shift) || !isset($office_shift[0]) || $office_shift[0]->sunday_in_time == '') {
					$in_time = '00:00:00';
					$out_time = '00:00:00';
				} else {

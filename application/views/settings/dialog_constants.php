...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->document_type_id;?>/" method="post" name="ed_document_type_info" id="ed_document_type_info">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->contract_type_id;?>/" method="post" name="ed_contract_type_info" id="ed_contract_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->payment_method_id;?>/" method="post" name="ed_payment_method_info" id="ed_payment_method_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->education_level_id;?>/" method="post" name="ed_education_level_info" id="ed_education_level_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->language_id;?>/" method="post" name="ed_qualification_language_info" id="ed_qualification_language_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->skill_id;?>/" method="post" name="ed_qualification_skill_info" id="ed_qualification_skill_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->award_type_id;?>/" method="post" name="ed_award_type_info" id="ed_award_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->leave_type_id;?>/" method="post" name="ed_leave_type_info" id="ed_leave_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->warning_type_id;?>/" method="post" name="ed_warning_type_info" id="ed_warning_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->termination_type_id;?>/" method="post" name="ed_termination_type_info" id="ed_termination_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->expense_type_id;?>/" method="post" name="ed_expense_type_info" id="ed_expense_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->job_type_id;?>/" method="post" name="ed_job_type_info" id="ed_job_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->exit_type_id;?>/" method="post" name="ed_exit_type_info" id="ed_exit_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->arrangement_type_id;?>/" method="post" name="ed_travel_arr_type_info" id="ed_travel_arr_type_info">
  <input type="hidden" name="_method" value="EDIT">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/<?php echo $row[0]->currency_id;?>/" method="post" name="ed_currency_type_info" id="ed_currency_type_info">
  <input type="hidden" name="_method" value="EDIT">

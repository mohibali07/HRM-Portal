...
<form class="m-b-1" action="<?php echo site_url("trainers/update").'/'.$trainer_id; ?>
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/" method="post" name="edit_trainer" id="edit_trainer">

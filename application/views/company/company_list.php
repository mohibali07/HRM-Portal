              ...
              <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="company_type" data-plugin="xin_select"
                          ...
                          <?php foreach ($get_company_types as $ctype) { ?>
                            <option value="<?php echo $ctype->contract_type_id; ?>"> <?php echo $ctype->name; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_contact_number'); ?>"
                          name="contact_number" type="number">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('xin_gtax'); ?>"

      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box box-block bg-white">
            ...
            <form class="m-b-1 add" id="contract_type_info"
              action="<?php echo site_url("settings/contract_type_info") ?>" name="contract_type_info" method="post">
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box box-block bg-white">
            ...
            <form class="m-b-1 add" id="document_type_info"
              action="<?php echo site_url("settings/document_type_info") ?>" name="document_type_info" method="post">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="form-group">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            <h2><strong><?php echo $this->lang->line('xin_list_all'); ?></strong>
              <?php echo $this->lang->line('xin_warning_type'); ?></h2>
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="xin_table_warning_type"
                style="width:100%;">
                <thead>
                  <tr>
                    <th><?php echo $this->lang->line('xin_action'); ?></th>
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            <h2><strong><?php echo $this->lang->line('xin_list_all'); ?></strong>
              <?php echo $this->lang->line('xin_expense_type'); ?></h2>
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="xin_table_expense_type"
                style="width:100%;">
                <thead>
                  <tr>
                    <th><?php echo $this->lang->line('xin_action'); ?></th>
        ...
        <div class="col-md-5">
          <div class="box box-block bg-white">
            ...
            <form class="m-b-1 add" id="travel_arr_type_info"
              action="<?php echo site_url("settings/travel_arr_type_info") ?>" name="travel_arr_type_info"
              method="post">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="box box-block bg-white">
            ...
            <form class="m-b-1 add" id="currency_type_info"
              action="<?php echo site_url("settings/currency_type_info") ?>" name="currency_type_info" method="post">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="form-group">

...
<form class="m-b-1" action="<?php echo site_url("settings/update_template").'/'.$template_id; ?>
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">/" method="post" name="update_template" id="update_template">

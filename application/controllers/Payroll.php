	...
	public function pdf_create()
	{
		...
		if ($system[0]->is_payslip_password_generate == 1) {
			...
			if ($system[0]->payslip_password_format == 'dateofbirth') {
				...
				// Password is hashed, fallback to contact_no
				$password_val = $user[0]->contact_no;
			} else if ($system[0]->payslip_password_format == 'user_password') {
				// Password is hashed, fallback to username + contact_no
				$password_val = $user[0]->username . $user[0]->contact_no;
				...
				// Password is hashed, fallback to employee_id + contact_no
				$password_val = $user[0]->employee_id . $user[0]->contact_no;

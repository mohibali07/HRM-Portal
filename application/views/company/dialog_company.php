...
if (isset($_GET['jd']) && isset($_GET['company_id']) && $_GET['data'] == 'company') {
  ...
  <form class="m-b-1" action="<?php echo site_url("company/update") . '/' . $company_id; ?>" method="post" name="edit_company"
    id="edit_company">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_name'); ?>" name="name"
              ...
              <div class="col-md-6">
                ...
                <select class="form-control" name="company_type" data-plugin="select_hrm"
                  ...
                  <?php foreach ($get_company_types as $ctype) { ?>
                    <option value="<?php echo $ctype->contract_type_id; ?>" <?php if ($type_id == $ctype->contract_type_id) { ?>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_registration'); ?>"
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_contact_number'); ?>"
                  name="contact_number" type="number" value="<?php echo $contact_number; ?>">
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <?php if ($logo != '' || $logo != 'no-file') { ?>
              <div class="avatar box-48 mr-0-5"> <img class="b-a-radius-circle"
                  src="<?php echo site_url(); ?>uploads/company/<?php echo $logo; ?>" alt=""> </div>
            <?php } ?>
            <br>
        ...
        <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_address_1'); ?>" name="address_1"
              type="text" value="<?php echo $address_1; ?>">
            <br>
            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_address_2'); ?>" name="address_2"
            ...
            <div class="row">
              ...
              <div class="col-xs-3">
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_zipcode'); ?>" name="zipcode"
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="display: table-cell;"><?php foreach ($get_company_types as $ctype) { ?>
                <?php if ($type_id == $ctype->contract_type_id) { ?>
                  <?php echo $ctype->name; ?>
                <?php }
              } ?>
              </td>
          ...
          <?php } ?>
            ...
            <tr>
              ...
              <td style="display: table-cell;"><?php if ($logo != '' || $logo != 'no-file') { ?>
                  <div class="avatar box-48 mr-0-5"> <img src="<?php echo site_url(); ?>uploads/company/<?php echo $logo; ?>"
                      alt=""></a> </div>
              <?php } ?>
              </td>
            </tr>

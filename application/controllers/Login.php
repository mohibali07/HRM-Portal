...
class Login extends MY_Controller
{
	...
	public function auth()
	{
		...
		if ($result) {
			...
			// Verify password (hash or plain text for backward compatibility if needed, but we are enforcing hash)
			// For fresh install, we assume hash. If migrating, we might need a check.
			// Since user asked for hash system, we implement password_verify.

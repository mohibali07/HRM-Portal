...
if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_document_type' && $_GET['type'] == 'ed_document_type') {
	...
	<form class="m-b-1" action="<?php echo site_url("settings/update_document_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
		value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->document_type_id; ?>/" method="post"
		name="ed_document_type_info" id="ed_document_type_info">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_contract_type' && $_GET['type'] == 'ed_contract_type') {
	...
	?>
		...
		<form class="m-b-1" action="<?php echo site_url("settings/update_contract_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
			value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->contract_type_id; ?>/" method="post"
			name="ed_contract_type_info" id="ed_contract_type_info">
			<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_payment_method' && $_GET['type'] == 'ed_payment_method') {
	...
	?>
			...
			<form class="m-b-1" action="<?php echo site_url("settings/update_payment_method") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
				value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->payment_method_id; ?>/" method="post"
				name="ed_payment_method_info" id="ed_payment_method_info">
				<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_education_level' && $_GET['type'] == 'ed_education_level') {
	...
	?>
				...
				<form class="m-b-1" action="<?php echo site_url("settings/update_education_level") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
					value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->education_level_id; ?>/" method="post"
					name="ed_education_level_info" id="ed_education_level_info">
					<input type="hidden" name="_method" value="EDIT">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="name"
								class="form-control-label"><?php echo $this->lang->line('xin_e_details_edu_level'); ?>:</label>
							<input type="text" class="form-control" name="name"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_qualification_language' && $_GET['type'] == 'ed_qualification_language') {
	...
	?>
					...
					<form class="m-b-1" action="<?php echo site_url("settings/update_qualification_language") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
						value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->language_id; ?>/" method="post"
						name="ed_qualification_language_info" id="ed_qualification_language_info">
						<input type="hidden" name="_method" value="EDIT">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="name"
									class="form-control-label"><?php echo $this->lang->line('xin_e_details_language'); ?>:</label>
								<input type="text" class="form-control" name="name"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_qualification_skill' && $_GET['type'] == 'ed_qualification_skill') {
	...
	?>
						...
						<form class="m-b-1" action="<?php echo site_url("settings/update_qualification_skill") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
							value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->skill_id; ?>/" method="post"
							name="ed_qualification_skill_info" id="ed_qualification_skill_info">
							<input type="hidden" name="_method" value="EDIT">
							...
							<div class="modal-body">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name"
										placeholder="<?php echo $this->lang->line('xin_skill'); ?>" value="<?php echo $row[0]->name; ?>">
								</div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_award_type' && $_GET['type'] == 'ed_award_type') {
	...
	?>
							...
							<form class="m-b-1" action="<?php echo site_url("settings/update_award_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
								value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->award_type_id; ?>/" method="post"
								name="ed_award_type_info" id="ed_award_type_info">
								<input type="hidden" name="_method" value="EDIT">
								...
								<div class="modal-body">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="name"
											...
											value="<?php echo $row[0]->award_type; ?>">
									</div>
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_leave_type' && $_GET['type'] == 'ed_leave_type') {
	...
	?>
								...
								<form class="m-b-1" action="<?php echo site_url("settings/update_leave_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
									value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->leave_type_id; ?>/" method="post"
									name="ed_leave_type_info" id="ed_leave_type_info">
									<input type="hidden" name="_method" value="EDIT">
									...
									<div class="modal-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="name"
												...
												value="<?php echo $row[0]->type_name; ?>">
										</div>
										<div class="form-group">
											<label for="days_per_year"
												class="form-control-label"><?php echo $this->lang->line('xin_days_per_year'); ?>:</label>
											<input type="text" class="form-control" name="days_per_year"
												placeholder="<?php echo $this->lang->line('xin_days_per_year'); ?>"
												value="<?php echo $row[0]->days_per_year ?>">
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_warning_type' && $_GET['type'] == 'ed_warning_type') {
	...
	?>
									...
									<form class="m-b-1" action="<?php echo site_url("settings/update_warning_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
										value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->warning_type_id; ?>/" method="post"
										name="ed_warning_type_info" id="ed_warning_type_info">
										<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_termination_type' && $_GET['type'] == 'ed_termination_type') {
	...
	?>
										...
										<form class="m-b-1" action="<?php echo site_url("settings/update_termination_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
											value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->termination_type_id; ?>/" method="post"
											name="ed_termination_type_info" id="ed_termination_type_info">
											<input type="hidden" name="_method" value="EDIT">
											...
											<div class="modal-body">
												<div class="form-group">
													<label for="name"
														class="form-control-label"><?php echo $this->lang->line('xin_termination_type'); ?>:</label>
													<input type="text" class="form-control" name="name"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_expense_type' && $_GET['type'] == 'ed_expense_type') {
	...
	?>
											...
											<form class="m-b-1" action="<?php echo site_url("settings/update_expense_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
												value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->expense_type_id; ?>/" method="post"
												name="ed_expense_type_info" id="ed_expense_type_info">
												<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_job_type' && $_GET['type'] == 'ed_job_type') {
	...
	?>
												...
												<form class="m-b-1" action="<?php echo site_url("settings/update_job_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
													value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->job_type_id; ?>/" method="post"
													name="ed_job_type_info" id="ed_job_type_info">
													<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_exit_type' && $_GET['type'] == 'ed_exit_type') {
	...
	?>
													...
													<form class="m-b-1" action="<?php echo site_url("settings/update_exit_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
														value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->exit_type_id; ?>/" method="post"
														name="ed_exit_type_info" id="ed_exit_type_info">
														<input type="hidden" name="_method" value="EDIT">
														...
														<div class="modal-body">
															<div class="form-group">
																<label for="name"
																	class="form-control-label"><?php echo $this->lang->line('xin_employee_exit_type'); ?>:</label>
																<input type="text" class="form-control" name="name"
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_travel_arr_type' && $_GET['type'] == 'ed_travel_arr_type') {
	...
	?>
														...
														<form class="m-b-1" action="<?php echo site_url("settings/update_travel_arr_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
															value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->arrangement_type_id; ?>/" method="post"
															name="ed_travel_arr_type_info" id="ed_travel_arr_type_info">
															<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_currency_type' && $_GET['type'] == 'ed_currency_type') {
	...
	?>
															...
															<form class="m-b-1" action="<?php echo site_url("settings/update_currency_type") ?>
<input type=" hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
																value="<?php echo $this->security->get_csrf_hash(); ?>">/<?php echo $row[0]->currency_id; ?>/" method="post"
																name="ed_currency_type_info" id="ed_currency_type_info">
																<input type="hidden" name="_method" value="EDIT">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['user_id']) && $_GET['data'] == 'password' && $_GET['type'] == 'password') { ?>
																...
																<form id="profile_password" action="<?php echo site_url("employees/change_password"); ?>" name="e_change_password"
																	method="post">
																	<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
																			...
																			<div class="col-md-6">
																				<div class="form-group">
																					...
																					<input class="form-control"
																						placeholder="<?php echo $this->lang->line('xin_e_details_enpassword'); ?>" name="new_password"
																						type="text">
																				</div>
																			</div>
																			<div class="col-md-6">
...
<?php } else if (isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data'] == 'ed_company_type' && $_GET['type'] == 'ed_company_type') {
	$row = $this->Company_model->read_company_type_information($_GET['field_id']);
	?>
																		<div class="modal-header">
																			<button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span>
																			</button>
																		...
																		<form class="m-b-1" action="<?php echo site_url("settings/update_company_type") ?>/<?php echo $row[0]->type_id; ?>/"
																			method="post" name="ed_company_type_info" id="ed_company_type_info">
																			<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
																				value="<?php echo $this->security->get_csrf_hash(); ?>">
																			<input type="hidden" name="_method" value="EDIT">
																			<input type="hidden" name="_token" value="<?php echo $row[0]->type_id; ?>">
																			<input type="hidden" name="edit_type" value="company_type">
																			<div class="modal-body">
																				<div class="form-group">
																			...
																			$(document).ready(function () {
																				...
																				$("#ed_company_type_info").submit(function (e) {
																					...
																					$.ajax({
																						type: "POST",
																						url: e.target.action,
																						data: obj.serialize() + "&is_ajax=21&type=edit_record&data=ed_company_type_info&form=" + action,
																						cache: false,
																						success: function (JSON) {
																							if (JSON.error != '') {
																								toastr.error(JSON.error);
